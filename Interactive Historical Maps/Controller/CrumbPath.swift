...
class CrumbPath: NSObject, MKOverlay {
    ...
    private var dateMap : [HistoricalDate:Int] = [:]
    ...
    //
    func addCoordinate(_ newCoord: CLLocationCoordinate2D, boundingMapRectChanged boundingMapRectChangedOut: UnsafeMutablePointer<Bool>?, on date: HistoricalDate) -> MKMapRect {
        ...
        let _lastIndex = index(for: date)
        
        // Get the distance between this new point and the previous point.
        let prevPoint = pointBuffer[lastIndex]
        ...
        if metersApart > MINIMUM_DELTA_METERS {
            ...
            pointBuffer[lastIndex+1] = newPoint
            dateMap[date] = lastIndex+1
    ...
    func dateChanged(to date: HistoricalDate) {
